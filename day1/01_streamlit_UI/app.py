...
if st.button("Go to Google"):
    st.markdown("[Click here](https://www.google.com)", unsafe_allow_html=True)

st.chat_input(placeholder="Type Anything Here. It absolutely does nothing.", key=None, max_chars=None, accept_file=False, file_type=None, disabled=False, on_submit=None, args=None, kwargs=None)
